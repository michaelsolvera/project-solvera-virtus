...
class WizardTukarFaktur(models.TransientModel):
    ...
    def get_all_invoice(self):
        ...
        if self.partner_id:
            ...
            temp=[]
            partner_obj = self.env['account.move'].search([('partner_id','=',self.partner_id.id)
    ...
    def create_kwitansi(self):
        ...
        return self.env.ref('solvera_kwitansi_gabungan.report_kwitansi').report_action(self, data=data)