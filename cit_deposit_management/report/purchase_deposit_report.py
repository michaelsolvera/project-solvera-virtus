...
class ReportPurchaseDeposit(models.AbstractModel):
    _name = 'report.cit_deposit_management.purchase_deposit_template'
    _description = 'Purchase Deposit Report Template'
    ...
    def _get_report_values(self, docids, data=None):
        Report = self.env['ir.actions.report']._get_report_from_name(
            'cit_deposit_management.purchase_deposit_template')
        ...
        docargs = {
            'doc_ids': data['form'][0]['vendor_ids'],
            'doc_model': Report.model,
            'docs': self.env['purchase.report.wz'].browse(data['form'][0]['id']),
            'form':data['form'][0],
            'monthlist':monthlist,
        }
        return docargs
