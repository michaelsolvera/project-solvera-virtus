...

{
    ...
    'description': 'Send Product and Stock Picking (In, Out, Internal Transfer, Returns). Product Templates. Real All in One. Send and receive messages. Real ChatRoom. WhatsApp integration. WhatsApp Connector. apichat.io. GupShup. Chat-Api. ChatApi. Drag and Drop.',
    'version': '14.0.1',
    'author': 'AcruxLab',
