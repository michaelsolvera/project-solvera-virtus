...
class AccountMove(models.Model):
    ...
    def name_get(self):
        ...
        for line in self:
            if line.property_id:
                if line.property_id.project_name and line.property_id.name:
                    name = line.property_id.project_name +'/'+line.property_id.name
                if line.property_id.project_name == None:
                     name = line.property_id.name
                if line.property_id.name == None:
                    name = line.property_id.project_name
